...
<div x-data="{ sidebarOpen: false, masterOpen: true }" class="min-h-screen bg-slate-50">
    <div x-show="sidebarOpen" x-cloak @click="sidebarOpen = false" class="fixed inset-0 z-40 bg-slate-900/40 lg:hidden">
    </div>
    ...
    <aside
            ...
            <div class="mt-3 space-y-1">
                ...
                <button type="button" @click="masterOpen = !masterOpen"
                    class="flex w-full items-center justify-between rounded-xl px-3 py-3 text-sm font-semibold text-slate-600 hover:bg-slate-50 hover:text-brand-600"><span
                        ...
                        :class="masterOpen ? 'rotate-180' : ''" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
                        <path d="m6 9 6 6 6-6" />
                    </svg></button>
        ...
        <div class="border-t border-slate-100 p-4">
            <div class="flex items-center gap-3 rounded-xl bg-slate-50 p-3"><img src="https://i.pravatar.cc/80?img=12"
                    alt="Avatar {{ auth()->user()->name }}" class="h-9 w-9 rounded-full object-cover">
                <div class="min-w-0 flex-1">
                    ...
                    aria-label="Keluar"><svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
    ...
    <div class="lg:pl-72">
        <header
            ...
            <div class="flex items-center gap-3"><button type="button" @click="sidebarOpen = true"
                ...
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-brand-600">{{ $section }}</p>
